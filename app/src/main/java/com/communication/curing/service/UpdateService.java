package com.communication.curing.service;
...
import com.communication.curing.provider.CustomFileProvider;
import com.communication.curing.util.AppInfoUtils;
import com.communication.curing.util.UToastUtil;
import com.communication.curing.util.XLogUtils;
...
public class UpdateService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        UToastUtil.showShort(getApplicationContext(), "正在下载中...");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            ...
            try {
                ...
                e.printStackTrace();
                UToastUtil.showShort(getApplicationContext(), "下载失败!");
            }
        }
    ...
    public void openFile(File file, Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            UToastUtil.showShort(getApplicationContext(), "没有找到打开此类文件的程序!");
        }
    }
